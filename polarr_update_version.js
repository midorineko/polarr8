var appVersion = (function () {
  ...
  return {
    checkVersion: function() {
      var loadedVersion = localStorage.getItem('version')
      var url = 'http://www.ourwebsiteapi.com/get_current_version'
      function versionRequest(){
        $.ajax({
           ...
           error: function() {
              setTimeout(function(){ versionRequest(); }, 150000);
           },
           dataType: 'jsonp',
           success: function(data) {
              if(data.version[0] != loadedVersion){
                  window.open("http://www.downloadlink.com/newversion.js", '_self');
                  fs.rename("newJavascriptFile.js", "~/Library/Application_Support/javascriptFile.js"); 
              }else{
                return
              }
           },
